...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_UP, DF(1),
        KC_SPC, KC_SPC, f(1), f(2), f(3), KC_LEFT, KC_DOWN, KC_RIGHT, 
        KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5,
       KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T,
       F(1), KC_A, KC_S, KC_D, KC_F, KC_G,
       KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B,
       KC_LCTL, KC_LGUI, KC_LALT, DF(1), KC_SPC, KC_SPC
    ),
...
[MDIA] = KEYMAP(
       ...
       KC_TRNS, KC_TRNS, KC_TRNS, KC_MS_U, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
